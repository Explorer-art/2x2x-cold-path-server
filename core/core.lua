	...
	elseif offer[2] == "trade" then
		if relations.available_trade(offer[3], offer[4]) then
			...
			for i = 2, #offer[5].player_trade_list do
				...
				elseif it == "gold" and game_data.lands[offer[3]].money >= val and val >= 0 then
				...
				elseif it == "per_turn" and game_data.lands[offer[3]].economy.balance >= val and val >= 0 then
				...
				elseif it == "resource" then
					...
					if game_data.lands[offer[3]].resources[resource] >= count and count >= 0 then
