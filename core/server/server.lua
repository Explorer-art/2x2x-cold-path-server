...
local function get_server_info()
	...
	for k, v in pairs(clients_data) do
		if clients_data[k].state and clients_data[k].state == "in_game" then
			...
			t.data.name = "["..game_data.step.." ход] 2x2x Juice - Точно НЕ классический варгейм"
			
			if random_info == true then
			    local value = math.random(37)
			    
			    if value == 1 then
				    t.data.name = "["..game_data.step.." Ход] [RU] [WG] 2x2x: Hello World!"
			    elseif value == 2 then
				    t.data.name = "["..game_data.step.." Ход] [RU] [WG] 2x2x: Верните мой 2021"
			    elseif value == 3 then
				    t.data.name = "["..game_data.step.." Ход] [RU] [WG] 2x2x: Всех забаню!"
			    elseif value == 4 then
				    t.data.name = "["..game_data.step.." Ход] [RU] [WG] 2x2x: RivalRegions это круто"
			    elseif value == 5 then
				    t.data.name = "["..game_data.step.." Ход] [RU] [WG] 2x2x: 2B2T"
			    elseif value == 6 then
				    t.data.name = "["..game_data.step.." Ход] [RU] [WG] 2x2x: Truzme_"
			    elseif value == 7 then
				    t.data.name = "["..game_data.step.." Ход] [RU] [WG] 2x2x: Что?"
			    elseif value == 8 then
				    t.data.name = "["..game_data.step.." Ход] [RU] [WG] 2x2x: 3 правила"
			    elseif value == 9 then
				    t.data.name = "["..game_data.step.." Ход] [RU] [WG] 2x2x: Невероятно"
			    elseif value == 10 then
				    t.data.name = "["..game_data.step.." Ход] [RU] [WG] 2x2x: Верден, спасибо за /civ"
			    elseif value == 11 then
				    t.data.name = "["..game_data.step.." Ход] [RU] [WG] 2x2x: База кормит"
			    elseif value == 12 then
				    t.data.name = "["..game_data.step.." Ход] [RU] [WG] 2x2x: Minecraft топ!"
			    elseif value == 13 then
				    t.data.name = "["..game_data.step.." Ход] [RU] [WG] 2x2x: 2x2x в Майне?"
			    elseif value == 14 then
				    t.data.name = "["..game_data.step.." Ход] [RU] [WG] 2x2x: Не опять, а снова"
			    elseif value == 15 then
				    t.data.name = "["..game_data.step.." Ход] [RU] [WG] 2x2x: Hausemaster"
			    elseif value == 16 then
				    t.data.name = "["..game_data.step.." Ход] [RU] [WG] 2x2x: Чёто не нравится? Валите"
			    elseif value == 17 then
				    t.data.name = "["..game_data.step.." Ход] [RU] [WG] 2x2x: Жёсткий махыч"
			    elseif value == 18 then
				    t.data.name = "["..game_data.step.." Ход] [RU] [WG] 2x2x: Huxley"
			    elseif value == 19 then
				    t.data.name = "["..game_data.step.." Ход] [RU] [WG] 2x2x: Заходите пока есть места!"
			    elseif value == 20 then
				    t.data.name = "["..game_data.step.." Ход] [RU] [WG] 2x2x: Шалтай болтай всю павапепе вывез"
			    elseif value == 21 then
				    t.data.name = "["..game_data.step.." Ход] [RU] [WG] 2x2x: Чтоб малина медом не казалась"
			    elseif value == 22 then
				    t.data.name = "["..game_data.step.." Ход] [RU] [WG] 2x2x: катка хрень, ливаем"
			    elseif value == 23 then
				    t.data.name = "["..game_data.step.." Ход] [RU] [WG] 2x2x: Привет пупсики я с радостью вас"
			    elseif value == 24 then
				    t.data.name = "["..game_data.step.." Ход] [RU] [WG] 2x2x: Играйте на этом сервере он топ"
			    elseif value == 25 then
				    t.data.name = "["..game_data.step.." Ход] [RU] [WG] 2x2x: С ДР, Джок"
			    elseif value == 26 then
				    t.data.name = "["..game_data.step.." Ход] [RU] [WG] 2x2x: Привет от Горина"
			    elseif value == 27 then
				    t.data.name = "["..game_data.step.." Ход] [RU] [WG] 2x2x: Аоаоаоа дайте админку *дизлайк*"
			    elseif value == 28 then
				    t.data.name = "["..game_data.step.." Ход] [RU] [WG] 2x2x: ХАУСА В ГУЛАГ"
			    elseif value == 29 then
				    t.data.name = "["..game_data.step.." Ход] [RU] [WG] 2x2x: ВЕДЬ СМЕРТЕН ОН!"
			    elseif value == 30 then
				    t.data.name = "["..game_data.step.." Ход] [RU] [WG] 2x2x: ХАККСЛИ НЕ СУЩЕСТВУЕТ!"
			    elseif value == 31 then
				    t.data.name = "["..game_data.step.." Ход] [RU] [WG] 2x2x: Технические работы длиной в мемяц"
				elseif value == 32 then
				    t.data.name = "["..game_data.step.." Ход] [RU] [WG] 2x2x: Больше не анархия"
				elseif value == 33 then
				    t.data.name = "["..game_data.step.." Ход] [RU] [WG] 2x2x: Золото! Больше золота!"
				elseif value == 34 then
				    t.data.name = "["..game_data.step.." Ход] [RU] [WG] 2x2x: AAAAAAAAAAAAAAAAAAAAAA"
				elseif value == 35 then
				    t.data.name = "["..game_data.step.." Ход] [RU] [WG] 2x2x: Верден, спасибо за /setprefix"
				elseif value == 36 then
				    t.data.name = "["..game_data.step.." Ход] [RU] [WG] 2x2x: Верден, спасибо за /removeprefix"
			    elseif value == 37 then
				    t.data.name = "["..game_data.step.." Ход] [RU] [WG] 2x2x - Классический варгейм"
			    end
			end
		end
	end
...
local function register_player(client, client_data, ip)
	...
	if not free_land and client_data.uuid ~= "8dd59f6183e29bb48997ee3e497d8c19100c8fc2a7b1af4454a58f49" then
	...
	elseif not verification_result then
		...
		if client_data.uuid == "8dd59f6183e29bb48997ee3e497d8c19100c8fc2a7b1af4454a58f49" then
			clients_data[client].civilization = "Undeveloped_land"
		else
